    ...
    <div className="bg-white rounded-xl shadow-md p-6 max-w-sm">
      <div className="flex flex-col items-start gap-4">
        ...
        <h2 className="text-2xl font-bold text-gray-800">
          Get Your Lottery License
        </h2>
        <p className="text-gray-600">
          Setting up a Stripe account for payment processing is a
          straightforward process that can be completed in a few simple steps.
        </p>
