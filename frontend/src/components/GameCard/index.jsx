    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 bg-white p-6 justify-start items-start">
          ...
          <button className="mt-2 inline-flex items-center justify-center px-4 py-2 border text-sm font-medium rounded-md border-gray-900 text-gray-900 rounded-[100px] gap-3">
            {btnText}
